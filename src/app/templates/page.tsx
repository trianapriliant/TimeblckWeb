...
import { AddEditTemplateSheet } from '@/components/add-edit-template-sheet';
...
import { Icon, HabitIconName } from '@/components/icon-map';
                  ...
                  <CardContent className="flex-grow">
                     <div className="flex items-center gap-2">
                        {DAY_MAP.map((day, index) => {
                          ...
                          const dayStyle = isCustomColor && isDayActive ? { 
                            backgroundColor: template.color, 
                            color: getContrastingTextColor(template.color)
                          } : {};
                          ...
                          return (
                            <div 
                              ...
                              className={cn(
                                ...
                                isDayActive && !isCustomColor
                                  ? `${colorClasses?.solid} ${colorClasses?.foreground}`
          ...
          <ScrollArea className="h-72">
            <div className="p-1 space-y-2">
              {SUGGESTED_TEMPLATES.map((template, index) => (
                ...
                >
                  <div className={cn("p-2 mt-1 rounded-lg w-10 h-10", BLOCK_COLORS[template.color as keyof typeof BLOCK_COLORS].solid)}>
                  </div>
                  <div>
