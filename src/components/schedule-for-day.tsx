      ...
      {scheduledBlocks.length > 0 ? (
        <div className="space-y-2">
          {scheduledBlocks.map((block) => {
            ...
            const colorClass = !isCustomColor ? BLOCK_COLORS[block.color as keyof typeof BLOCK_COLORS]?.solid || BLOCK_COLORS.slate.solid : '';
            ...
            return (
              ...
              >
                <div className={cn('h-10 w-2 rounded-full', colorClass)} style={style} />
